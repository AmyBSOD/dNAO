...
{	{"Archeologist", 0}, {
	...
	ART_ITLACHIAYAQUE,
	MA_HUMAN|MA_CLOCK|MA_ANIMAL|MA_DWARF|MA_ELF|MA_GNOME|MA_DRAGON|MA_ORC|MA_VAMPIRE|MA_FEY, ROLE_MALE|ROLE_FEMALE |
...
{	{"Healer", 0}, {
	...
	MA_HUMAN|MA_CLOCK|MA_ANIMAL|MA_DWARF|MA_ELF|MA_GNOME|MA_DRAGON|MA_ORC|MA_VAMPIRE|MA_FEY, ROLE_MALE|ROLE_FEMALE | ROLE_LAWFUL|ROLE_NEUTRAL|ROLE_CHAOTIC,
	/* Str Int Wis Dex Con Cha */
	{   7,  7, 13,  7, 11, 16 },
	{  15, 20, 20, 15, 25, 5 },
	/* Init   Lower  Higher */
