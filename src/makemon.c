...
int type;
{
	switch(type) {
		...
		case PM_PLASTIC_GOLEM: return 30;
...
//		case PM_SAURON_THE_IMPRISONED: return 45;
		...
		case PM_RUBY_GOLEM: return 160;
		case PM_DIAMOND_GOLEM: return 200;
		case PM_SAPPHIRE_GOLEM: return 240;
		case PM_STEEL_GOLEM: return 320;
		case PM_CRYSTAL_GOLEM: return 360;
